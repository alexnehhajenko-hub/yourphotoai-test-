// api/generate-vip1.js — VIP стиль #1: ломанная гравитация
// FLUX-Kontext-Pro (Replicate)

import Replicate from "replicate";

// VIP #1 — Гравитация ломается, лицо = ТОТ ЖЕ человек
const VIP_BASE_PROMPT = [
  ...
  "new outfit matching the surreal scene, not the original t-shirt, stylish but realistic clothes",
  "main light source is a glowing pool of light on the table or floor, casting soft cinematic light from below",
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("VIP#1 GENERATION ERROR:", err);
